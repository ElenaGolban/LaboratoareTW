...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    do {
        if ( empty($name) || empty($email) || empty($phone) || empty($address) || empty($job) || empty($education) || empty($graduateED) || empty($graduateUNIV) || empty($university) ) {
            $errorMessage = "All the fields are required";
            break;
        }

        // add new client to database
        $sql =  "INSERT INTO clients (name, email, phone, address, job, education, graduateED, graduateUNIV, university) " .
                "VALUES ('$name', '$email', '$phone', '$address', '$job', '$education', '$graduateED', '$graduateUNIV', '$university')";
